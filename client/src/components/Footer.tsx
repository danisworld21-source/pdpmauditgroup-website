      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2 text-sm">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-accent" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://pdpmauditopti-vxu7356.slack.com" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">Message Us on Slack</a>
              </li>
              <li className="flex items-center space-x-2 text-sm">
                <Mail className="h-4 w-4 text-accent" />
                <a href="mailto:info@pdpmauditgroup.com" className="hover:text-accent transition-colors">info@pdpmauditgroup.com</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <Link href="/contact">
              <Button className="w-full gradient-gold font-bold shadow-lg hover:shadow-xl transition-all">Get Started Today</Button>
            </Link>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/20">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-primary-foreground/60">© {new Date().getFullYear()} PDPM Audit Optimization Group. All rights reserved.</p>
